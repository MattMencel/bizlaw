        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="font-semibold text-lg">{status.migrations?.tables?.count || 0} tables</p>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="font-semibold text-lg">
                {status.migrations?.migrations?.applied || 0} / {status.migrations?.migrations?.total || 0} applied
              </p>
              <p className="text-xs text-gray-500 mt-1">
                {status.migrations?.migrations?.pending || 0} pending migrations
              </p>
            </div>
          </div>
            ...
            <div className="border-b pb-2 mb-4">
              ...
              >
                <span className="flex items-center">
                  ...
                  Pending Migrations ({status.migrations?.migrations?.pendingList?.length || 0})
                </span>
          ...
          <div className="mb-6">
            <div className="border-b pb-2 mb-4">
              ...
              >
                <span className="flex items-center">
                  <Check className="h-4 w-4 text-green-500 mr-2" />
                  Applied Migrations ({status.migrations?.migrations?.appliedList?.length || 0})
                </span>
